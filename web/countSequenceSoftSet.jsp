...
<html>
    ...
    <body>
        ...
        <%
                if (lowSeqMap.size() != 0) {
                    Util.printSoftSet(false, "LOW", lowSeqMap, request, response);
                }
                if (midSeqMap.size() != 0) {
                    Util.printSoftSet(false, "MID", midSeqMap, request, response);
                }
                if (highSeqMap.size() != 0) {
                    Util.printSoftSet(false, "HIGH", highSeqMap, request, response);
                }
        ...
        %>
    <center> <form action="crispSoftSet.jsp">
